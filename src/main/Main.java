...
/**
 * This is the main method that will launch the application. It contains the
 * mainStage that will be used to host the scenes for each page of the
 * application.
 * 
 */
...
public class Main extends Application {
	...
	/**
	 * This method is used to animate the logo on the Log In screen. It uses a
	 * variety of Transitions to create the finished animation
	 * 
	 * @param logoIV
	 *            the ImageView to be animated
	 */
	...
	public void start(Stage mainStage) throws Exception {
		...
		// Test if the user has launched the application before, and launch the
		// appropriate page
		try {
