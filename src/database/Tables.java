...
public class Tables {
	...
	public static final String CREATE_TABLE_MEMBERS = "CREATE TABLE " + TABLE_MEMBERS +
	 		...
	 		MEMBERS_COLUMN_FNAME + " VARCHAR(50), " + 
	 		MEMBERS_COLUMN_LNAME + " VARCHAR(50), " + 
	 		MEMBERS_COLUMN_ADDRESS + " VARCHAR(50), " + 
	 		MEMBERS_COLUMN_POSTALCODE + " VARCHAR(50), " +
			MEMBERS_COLUMN_CITY + " int NOT NULL, " + 
	 		MEMBERS_COLUMN_ACTIVE_MEMBERSHIP + " BOOLEAN, " +
			MEMBERS_COLUMN_MEMBERSHIP_LEVEL + " int NOT NULL, " + 
			MEMBERS_COLUMN_LOCATION + " int NOT NULL, " + 
	 		MEMBERS_COLUMN_REGISTRATION_DATE + " DATE, " +
	 		"FOREIGN KEY (" + MEMBERS_COLUMN_CITY + ") REFERENCES " + TABLE_CITIES + "(" + CITIES_COLUMN_ID + ")," +
	 		"FOREIGN KEY (" + MEMBERS_COLUMN_LOCATION + ") REFERENCES " + TABLE_LOCATIONS + "(" + LOCATIONS_COLUMN_ID + ")," +
	 		"FOREIGN KEY (" + MEMBERS_COLUMN_MEMBERSHIP_LEVEL + ") REFERENCES " + TABLE_MEMBER_LEVEL + "(" + MEMBER_LEVELS_COLUMN_ID + ")," +
	...
	public static final String CREATE_TABLE_LOCATIONS = "CREATE TABLE " + TABLE_LOCATIONS +
			 "(" + LOCATIONS_COLUMN_ID + " int NOT NULL AUTO_INCREMENT, " +
			       ...
			       LOCATIONS_COLUMN_POSTAL + " VARCHAR(50), " +
					LOCATIONS_COLUMN_CITY + " int NOT NULL, " + 
	...
	public static final String CREATE_TABLE_MANAGERS = "CREATE TABLE " + TABLE_MANAGERS +
			 "(" + MANAGERS_COLUMN_ID + " int NOT NULL AUTO_INCREMENT, " +
				   ...
				   "FOREIGN KEY (" + MANAGERS_COLUMN_CITY + ") REFERENCES " + TABLE_CITIES + "(" + CITIES_COLUMN_ID + ")," +
	...
	public static final String CREATE_TABLE_LOCATION_AMENITIES = "CREATE TABLE " + TABLE_LOCATION_AMENITIES +
			 "(" + LOCATION_AMENITIES_COLUMN_LOCATION + " int NOT NULL, " +
			       LOCATION_AMENITIES_COLUMN_AMENITY + " int NOT NULL, " + 
			       "FOREIGN KEY (" + LOCATION_AMENITIES_COLUMN_LOCATION + ") REFERENCES " + TABLE_LOCATIONS + "(" + LOCATIONS_COLUMN_ID + ")," +
			       "FOREIGN KEY (" + LOCATION_AMENITIES_COLUMN_AMENITY + ") REFERENCES " + TABLE_AMENITIES + "(" + AMENITIES_COLUMN_ID + "));";
	
	
	public static final String CREATE_TABLE_MEMBER_AMENITIES = "CREATE TABLE " + TABLE_MEMBER_AMENITIES +
			 "(" + MEMBER_AMENITIES_COLUMN_MEMBER_LEVEL + " int NOT NULL, " +
			 	   MEMBER_AMENITIES_COLUMN_AMENITY + " int NOT NULL, " + 
			       "FOREIGN KEY (" + MEMBER_AMENITIES_COLUMN_MEMBER_LEVEL + ") REFERENCES " + TABLE_MEMBER_LEVEL + "(" + MEMBER_LEVELS_COLUMN_ID + ")," +
			       "FOREIGN KEY (" + MEMBER_AMENITIES_COLUMN_AMENITY + ") REFERENCES " + TABLE_AMENITIES + "(" + AMENITIES_COLUMN_ID + "));";
	
	
	public static final String CREATE_TABLE_MANAGER_LOCATIONS = "CREATE TABLE " + TABLE_MANAGER_LOCATIONS +
			 "(" + MANAGER_LOCATIONS_COLUMN_MANAGER + " int NOT NULL, " +
			 	   MANAGER_LOCATIONS_COLUMN_LOCATION + " int NOT NULL, " + 
			       "FOREIGN KEY (" + MANAGER_LOCATIONS_COLUMN_MANAGER + ") REFERENCES " + TABLE_MANAGERS + "(" + MANAGERS_COLUMN_ID + ")," +
			       "FOREIGN KEY (" + MANAGER_LOCATIONS_COLUMN_LOCATION + ") REFERENCES " + TABLE_LOCATIONS + "(" + LOCATIONS_COLUMN_ID + "));";
